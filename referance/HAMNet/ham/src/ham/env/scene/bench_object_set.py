...
from ham.env.scene.util import sample_stable_poses, load_glb, load_npy, load_pkl
from ham.env.scene.object_set import ObjectSet
from ham.env.scene.apply_coacd import (Config as COACDConfig,
                                       apply_coacd)
import json
...
URDF_TEMPLATE: str = '''<robot name="robot">
    <link name="base_link">
        ...
        <visual>
            <origin xyz="0 0 0" rpy="0 0 0"/>ddd   qq
            <geometry>
...
class BenchObjectSet(ObjectSet):
    @dataclass
    class Config(ConfigBase):
        ...
        data_path: Optional[str] = '/input/bench'
