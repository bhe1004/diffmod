...
from env_wrappers import CountCategoricalSuccess
...
class Config(TrainConfig):
    ...
    cat_result_output: str = '/tmp/docker/result/'
...
def main(cfg: Config):
    ...
    if cfg.log_categorical_results:
        env = CountCategoricalSuccess(env, category='index',
                                      save_dir=cfg.cat_result_output)
